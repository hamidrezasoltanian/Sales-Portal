...
The receivables AI tab calls `https://api.anthropic.com/v1/messages` directly from the browser using model `Codex-sonnet-4-20250514`. API key provided by user at runtime.
...
| Codex API key config (env var or DB.settings.anthropicKey) | ⚙ Settings modal | ✅ |
...
cd /home/hamidreza/Sales-Portal && git pull origin Codex/hopeful-bardeen-iz7jf9 && pm2 restart sales-portal
